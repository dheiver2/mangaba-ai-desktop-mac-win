...
"""
    try:
        ...
        print(f'Mangaba AI v{VERSION} - building the best AI user interface.\nhttps://github.com/open-webui/open-webui')
...
try:
    ...
    log.warning(f'Embedding não configurado, RAG desabilitado: {e}')
    app.state.EMBEDDING_FUNCTION = None
...
async def generate_messages(
    ...
    All models configured in Mangaba AI are accessible via this endpoint.
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for Mangaba AI.
