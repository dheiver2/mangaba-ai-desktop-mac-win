...
# can't be a legitimate Mangaba AI collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current Mangaba AI naming conventions for
        collection names. If Mangaba AI changes how it generates collection names
