...
# Useful when Mangaba AI sits behind a reverse proxy / API gateway that
...
# compatible APIs for endpoints not natively handled by Mangaba AI.
...
WEBUI_NAME = os.getenv('WEBUI_NAME', 'Mangaba AI')
